 ...
 */
    ...
    // Incluir el widget
    require_once plugin_dir_path(__FILE__) . 'widget/ironplacecatalog-widget.php';

    // Incluir el shortcode
    require_once plugin_dir_path(__FILE__) . 'shortcode/ironplacecatalog-shortcode.php';
?>